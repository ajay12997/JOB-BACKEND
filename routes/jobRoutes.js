...
const { createJob, getAllJobs, getJobById,getJobsByRecruiter, deleteJob,updateJob,getRecommendedJobs } = require("../controllers/job.controller");
...
router.get("/recommendedJobs", authMiddleware, getRecommendedJobs); // Update a job
